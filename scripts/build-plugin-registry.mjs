...
const {v1,v2}=buildPluginRegistries({
 plugins:['plugins-store/pomodoro','resources/plugins/board','plugins-store/local-files','plugins-store/web-fetch','plugins-store/excel','plugins-store/powerpoint','plugins-store/weather'],
