...
> ✅ **8443 已在阿里云安全组放行**（2026-09-01 从本机实测 `nc -z 39.105.40.173 8443` 通，
> 同时测 `:443` 作对照排除本机网络问题）。**部署当天曾漏放行**，这里留着当时的判据：
> 服务器上 `127.0.0.1:8443` 通、`39.105.40.173:8443` 不通、`:443` 通、firewalld inactive
> —— 全中就说明主机侧没问题，是云上的入站规则，别再去查进程和防火墙。
