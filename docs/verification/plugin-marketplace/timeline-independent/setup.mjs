...
fs.mkdirSync(project+'/.eas',{recursive:true});const {record}=await import(path.join(root,'resources/plugins/timeline/lib/store.mjs'));record(project,{taskKey:'migration-history',title:'迁移前的成果',summary:'这条历史必须在独立化后仍可见',date:'2026-09-22',status:'verified',evidence:['隔离测试历史']});
