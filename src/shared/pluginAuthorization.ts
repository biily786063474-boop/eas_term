...
export type PluginAuthorizationAction='status'|'login'|'disconnect'|'test'
export type PluginAuthorizationResult={ok:true;status:PluginAuthorizationStatus;connection?:{toolCount:number;checkedAt:number}}|{ok:false;error:string}
