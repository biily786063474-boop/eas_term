...
test('production app shutdown and window cleanup route both soft/hard passes through owned control',()=>{
 ...
 const api=runInNewContext(code+'\n({killAllAgentChatSessions,killAgentChatSessionsForWebContents})',{timelineRuntime,sessions,cancelRuntimeStartup(live){cancelled.push(live.rec.id)},stopAgentProcess,interruptUsage(rec){accounted.push(rec.id)},retirePlanTurn(){},revokeCapabilitySession(){},forgetPty(){},transcripts:{drop(){}},setTimeout(fn){timers.push(fn);return {unref(){}}}})
