...
test('actual host shim gateway shares one remote connection across Claude/Codex/OMP identities',async t=>{
 ...
 const info={name:'fixture',displayName:'Fixture',cli:'eas',remote:{url:'https://mcp.example.com/mcp',approvedOrigins:['https://mcp.example.com'],auth:'none'}}
