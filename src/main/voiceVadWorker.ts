...
try {
 ...
 vad = binding.createVad(wasm, {sileroVad:{model:workerData.model,threshold:workerData.strong ? 0.65 : 0.5,minSpeechDuration:0.25,minSilenceDuration:0.2,windowSize:512,maxSpeechDuration:20},sampleRate:16000,numThreads:1,provider:'cpu',bufferSizeInSeconds:30})
